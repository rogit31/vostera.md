...
Feudal Aegur is a melting pot of cultures and races, reflecting the diverse demographics of the entire continent. Each fiefdom may have its own unique customs, traditions, and dialects. Many of the fiefdoms in Aegur are led by elves or half-elves, orcs or half-orcs, goliaths or tieflings.
...
Despite political differences, trade routes are relatively well established through Aegur, connecting the mineral-rich Shimmerpeak Alps with the lush jungles of the Aegurian Confederation to the east, as well as the different fiefdoms to the west. Major trade hubs, such as Nedanas and Sal'Sol, serve as bustling centers for the exchange of minerals, crafted goods, and unique natural resources, contributing to a vibrant economic landscape.
...
The expansion of the Kyrenian Empire into Aegur has introduced a foreign presence that adds complexity to the region. Conflicts over territory, resources, and influence create diplomatic tensions and challenge the autonomy of local rulers. 
...
As of recently the [[Ashir Empire]] has declared war onto the [[Aegurian Confederation]] as a result of their non-cooperation in the expatriation of [[Order of the Black Sun]] terrorists, though many speculate that the underlying reason is that the empire wishes to expand its control over the Shimmerpeak reserves of [[Zygonite]].
